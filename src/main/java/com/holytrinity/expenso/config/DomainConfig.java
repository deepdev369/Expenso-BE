package com.holytrinity.expenso.config;

import com.holytrinity.expenso.util.Jackson3JsonFormatMapper;
...
@Configuration
@EntityScan("com.holytrinity.expenso")
@EnableJpaRepositories("com.holytrinity.expenso")
