...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(com.holytrinity.expenso..*)")
    ...
    public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
        if (log.isDebugEnabled()) {
            ...
            // Log info level for entry in non-debug to verify flow
        ...
        try {
            ...
            if (log.isDebugEnabled()) {
                ...
                log.info("Exit: {}.{}() in {} ms", joinPoint.getSignature().getDeclaringTypeName(),
